...
public interface SourceOfTruth<K : Any, V : Any> {
     ...
     * [Aquifer.prefetchAll]), the conditional-batch validator gather, and
     * [Aquifer.revalidateActive]'s staleness sweep over the active key set. The default reads each
